  ...
  <div class="topbar">
    <div class="topbar-inner">
      <div class="topbar-contacts">
        ...
        <a href="tel:+242057911680"><i class="fa-solid fa-phone"></i> Brazzaville : +242 05 791 16 80</a>
      </div>
      <div class="topbar-social">
        <a href="https://www.facebook.com/profile.php?id=61565882327789" target="_blank" rel="noopener">
          <i class="fa-brands fa-facebook-f"></i> Facebook
        </a>
        <a href="https://www.linkedin.com/company/hpci-abidjansarl/" target="_blank" rel="noopener">
          <i class="fa-brands fa-linkedin-in"></i> LinkedIn
        </a>
        <a href="http://www.tiktok.com/@hpciabidjan.sarl" target="_blank" rel="noopener">
          <i class="fa-brands fa-tiktok"></i> TikTok
        </a>
        <a href="http://wa.me/2250706046595" target="_blank" rel="noopener">
